...
import net.teamio.gtams.network.PackageTradeData;
...
public abstract class GTamsCommonProxy {
	...
	public void registerPackets(SimpleNetworkWrapper network) {
		network.registerMessage(PackageTradeData.HandlerServer.class, PackageTradeRequest.class, 1, Side.SERVER);
		network.registerMessage(PackageTradeData.HandlerClient.class, PackageTradeData.class, 2, Side.CLIENT);
